            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                {(["A", "B", "C", "D"] as const).map((option) => {
                  const isCorrectOption = checked && option === question.correct_option;
                  const isWrongSelection = checked && selected === option && !isCorrectOption;
                  const selectedClass = isCorrectOption
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:items-start">
            ...
            <div>
              ...
              {showAnswer ? (
                ...
                <div className="flex min-h-48 items-center justify-center rounded-xl border border-dashed border-border bg-muted/20 p-6 text-center text-sm leading-6 text-muted-foreground">
                  Click “Show Answer” to display the answer alongside the question.
                </div>
              )}
            </div>
          </div>
  ...
  return (
    <div className="rounded-xl border border-primary/20 bg-primary/5 p-5">
      ...
      {question.answer_text && (
        <div className={question.correct_option ? "mt-5" : ""}>
