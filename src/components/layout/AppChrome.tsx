...
export default function HomePage() {
  return (
    <main className="relative min-h-[calc(100vh-5rem)] overflow-hidden bg-background">
      {/* Background glow */}
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-5rem)] max-w-6xl flex-col items-center justify-center px-5 py-16 text-center sm:px-8 lg:py-20">
        {/* Badge */}
        ...
        <div className="mb-8">
          <Image
            ...
            height={72}
            priority
            className="mx-auto h-auto w-[150px] sm:w-[190px]"
          />
        </div>
        ...
        <p className="mt-7 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg sm:leading-8">
          iSkole is being rebuilt into a modern learning platform for students
          and teachers. Question banks, learning resources, teacher-created
          content and much more — all in one place.
        </p>
        ...
        <div className="mt-10 w-full max-w-2xl rounded-3xl border border-border bg-card/80 p-6 shadow-xl shadow-primary/5 backdrop-blur-xl sm:p-8">
          <div className="flex flex-col items-center">
            ...
            <h2 className="mt-2 text-2xl font-bold text-foreground sm:text-3xl">
              iSkole.online is getting ready.
            </h2>

            <p className="mt-3 max-w-lg text-sm leading-6 text-muted-foreground">
              We&apos;re putting the finishing touches on the new platform.
              The new iSkole experience will be available soon.
            </p>

            {/* Progress line */}
            <div className="mt-7 w-full">
              <div className="mb-2 flex items-center justify-between text-xs font-medium text-muted-foreground">
                <span>Building the future of iSkole</span>
        ...
        <div className="mt-10 grid w-full max-w-3xl gap-3 sm:grid-cols-3">
          <Feature
            ...
            title="Question Bank"
            description="Practice from teacher-created questions."
          />

          <Feature
            icon={<GraduationCap size={20} />}
            title="Teacher Content"
            description="Learning material built around your subjects."
          />

          <Feature
            icon={<Sparkles size={20} />}
            title="Better Learning"
            description="A cleaner, smarter learning experience."
          />
        </div>
        ...
        <p className="mt-14 text-xs text-muted-foreground">
          © {new Date().getFullYear()} iSkole.online · Learn. Practice. Connect.
        </p>
      </div>
    </main>
  );
