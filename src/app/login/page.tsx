      ...
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-7xl items-center px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid w-full overflow-hidden rounded-3xl border border-border bg-card shadow-brand-lg lg:grid-cols-2">
          ...
          {/* ------------------------------------------------
              Left / Brand panel
          ------------------------------------------------ */}
          <div className="hidden min-h-[620px] flex-col justify-between bg-primary p-10 text-primary-foreground lg:flex xl:p-14">
            <div>
            ...
            <div>
              ...
              <p className="mt-6 max-w-md text-base leading-7 text-primary-foreground/75">
                Access your subjects, Question Bank, practice
                materials and personalised learning tools from
                one place.
              </p>
            </div>

            <div className="grid grid-cols-3 gap-3">
              <Feature label="Question Bank" />
              <Feature label="Practice" />
          ...
          <div className="flex min-h-[620px] items-center justify-center p-6 sm:p-10 lg:p-14">
            <div className="w-full max-w-md">
              ...
              <p className="mt-8 text-center text-xs leading-5 text-muted-foreground">
                By signing in, you agree to use iSkole
