...
export default function StudentQuestionPage() {
  ...
  function choose(questionId: string, option: string) { if (!result) setSelected((current) => ({ ...current, [questionId]: option })); }
